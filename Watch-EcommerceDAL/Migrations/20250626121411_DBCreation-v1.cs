...
{
    /// <inheritdoc />
    public partial class DBCreationv1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    GenderCategory = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    WaterResistance = table.Column<bool>(type: "bit", nullable: false),
                    WarrentyYears = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favourite", x => new { x.UserId, x.ProductId });
                    table.ForeignKey(
